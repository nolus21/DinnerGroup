...
<head>
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,400;0,500;0,700;1,100;1,400;1,500;1,700&display=swap"
    rel="stylesheet" />
  <!--fonts-->
  ...
  <script src="https://unpkg.com/three@0.112.0/examples/js/loaders/MTLLoader.js"></script>
  <script src="https://unpkg.com/three@0.126.0/examples/js/controls/OrbitControls.js"></script>


  <script src="https://unpkg.com/three@0.112.1/examples/js/loaders/DDSLoader.js"></script>
...
<form method="post" action="https://dinnergroup.dk/"  >
...
<script src="/projects\academia\contested_territories\js\contested-territories-3d.js">
        ...
        <?php include 'projects\architecture\uwdziedziniec\index.php';?>
